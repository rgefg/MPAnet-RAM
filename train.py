...
# 不再使用 amp.initialize，直接用model和optimizer
# 后续训练中用GradScaler和autocast来处理混合精度
...
if __name__ == '__main__':
    ...
    # load configuration
    customized_cfg = yaml.load(open(args.cfg, "r"), Loader=yaml.SafeLoader)#加载sysuyml
    cfg = strategy_cfg
    cfg.merge_from_file(args.cfg)         #sysu覆盖strategy
